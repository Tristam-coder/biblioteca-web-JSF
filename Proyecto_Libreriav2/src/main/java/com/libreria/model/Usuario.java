...
import jakarta.json.bind.annotation.JsonbTransient; // ¡IMPORTANTE! Importamos la anotación para excluir campos de la serialización JSON
...
public class Usuario implements Serializable {
    ...
    @OneToMany(mappedBy = "usuario")
    @JsonbTransient // <-- Se corrigió el campo 'historial' que causó el error.
    ...
    // ... Getters y Setters (sin cambios significativos)
