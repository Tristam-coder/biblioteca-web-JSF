...
public class EditorialResource {
    ...
    public Response listar() {
        List<Editorial> all = service.findAll();
    ...
    @POST
    public Response crear(Editorial editorial, @Context UriInfo uriInfo) {
    ...
    @PUT
    @Path("{id}")
    public Response actualizar(@PathParam("id") Integer id, Editorial cambios) {
